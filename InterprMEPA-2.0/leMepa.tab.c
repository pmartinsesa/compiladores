...
static const char *const yytname[] =
{
  ...
  "$accept", "linhas", "linha", "rot", "$@1", "virgula", "comando",
  "cmd_sem_param", "cmd_um_param_int", "cmd_um_param_rot",
